...
# 3 as the suggested number of clusters
...
```{r}
cluster_pallete <- c("#E64B3599", "#4DBBD599", "#00A08799")

fviz_cluster(pam3, data = data_scaled, ellipse.type = "norm", palette = cluster_pallete, ggtheme = theme_bw(), main = "Cluster plot - K-Medoids algorithm")
```
...
data_scaled_df_long <- data_scaled_df %>% gather(variable, value, q01_gender:concern_index, factor_key = TRUE)
