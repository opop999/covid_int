...
```{r}
data_full_1_3 <- data_full %>% 
  filter(country != "IT", 
         country != "FR", 
         country != "PL") %>% 
  filter(q02_age != "NA", q01_gender != "NA") 

data_full_4_6 <- data_full %>% 
  filter(country != "UK", 
         country != "CZ", 
         country != "SW") %>%  
  filter(q02_age != "NA", q01_gender != "NA")
...
data_full_1_3 %>%
  ggplot(aes(x = q02_age, 
             fill = q01_gender)) + 
  geom_bar(data = subset(data_full_1_3, 
                         q01_gender == "female")) + 
  geom_bar(data = subset(data_full_1_3, 
                         q01_gender == "male"), 
                         aes(y = ..count..*(-1))) + 
...
data_full_4_6 %>%
  ggplot(aes(x = q02_age, 
             fill = q01_gender)) + 
  geom_bar(data = subset(data_full_4_6, 
                         q01_gender == "female")) + 
  geom_bar(data = subset(data_full_4_6, 
                         q01_gender == "male"), 
                         aes(y = ..count..*(-1))) + 
